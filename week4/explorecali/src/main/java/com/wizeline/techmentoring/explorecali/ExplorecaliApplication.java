package com.wizeline.techmentoring.explorecali;
...
import com.wizeline.techmentoring.explorecali.service.TourPackageService;
import com.wizeline.techmentoring.explorecali.service.TourService;
...
public class ExplorecaliApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		createTours("ExploreCali.json");
		long numOfTours = tourService.total();
	}

	private void createdTourPackages() {
